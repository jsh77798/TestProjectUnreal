...
//
	...
	//{
	//	// 아이템을 먹은 경우
	//	SnakeBodyPart* newBodyPart = new SnakeBodyPart;
	//	newBodyPart->x = tail.x;
	//	newBodyPart->y = tail.y;
...
//
	...
	//		ASnakePart* Body = GetSnakeGameMode()->GetPart(GetActorLocation(), "Body");
			
	//		ASnakePart* Head = GetSnakeGameMode()->GetPart(GetActorLocation(), "Head");
	//		ASnakePart* Prev = Head;

			//AActor* CurNextPart = CurBody;
	...
	//			CurNextPart = CurNextPart->Next;
				...
				//CurNextPart -> PrevPos = CurNextPart->Next;
	//		}
	...
	//	while (nullptr != CurNextPart)
	//	{
	//		CurNextPart-> = CurNextPart->GetPart();
	//		CurNextPart->SetPos(CurNextPart->BodyType->PrevPos);
	//		CurNextPart = CurNextPart->Next;
	//	}
	//}
}
...
//void ASnakeGameMode::SpawnSnakeBody(FVector Location)
//{
//	// 스네이크 바디 생성
//	if (SnakeBodyClass)
//	{
//		ASnakePart* NewBodyPart = GetWorld()->SpawnActor<ASnakePart>(SnakeBodyClass, Location, FRotator::ZeroRotator);
//		// 바디의 PrevPos 설정
//		NewBodyPart->PrevPos = Location;
//	}
//}
